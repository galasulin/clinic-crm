...
| **Patients** | Full medical record, visits, collapsible intake sections, smart questionnaires, mailing-consent & referral panels, and a **unified activity timeline** that merges appointments, invoices, service cases, logged calls/messages, tasks and documents into one chronological, per-source-filterable feed |
